...
import { OTPRequest } from '../services/OTPrequest.vm';
import { DigiCustWithOTPRefNo } from '../services/DigiCustWithOTPRefNo';
...
import { OSRequest } from './OSRequest';
import { OSResponse } from './OSResponse';
import { RechargeModel } from '../View Models/RechargeModel';
import { TranResponse } from '../View Models/TranResponse';
import { RequestForDigiParty } from './RequestForDigiParty';
...
userToken:any;
   //constructor(private sqlite: SQLite,private httpclient:HttpClient,private locals:StorageService,private uihelper: UIHelperService,private http: Http) {
    constructor(private httpclient:HttpClient,private locals:StorageService,private uihelper: UIHelperService,private http: Http) {
